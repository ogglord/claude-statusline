...
# Reads /tmp/ccode-<uid>/session-<port>.json written by ccode on profile switch.
# Falls back to scanning pid files for older ccode versions.
ccode_label=""
